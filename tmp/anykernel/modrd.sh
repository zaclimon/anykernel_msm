...
sed '/cpu3\/cpufreq\/scaling_min_freq 384000/ a\    write /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq 1242000' -i init.mako.rc
sed '/cpu0\/cpufreq\/scaling_max_freq 1242000/ a\    write /sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq 1242000' -i init.mako.rc
sed '/cpu1\/cpufreq\/scaling_max_freq 1242000/ a\    write /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq 1242000' -i init.mako.rc
sed '/cpu2\/cpufreq\/scaling_max_freq 1242000/ a\    write /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq 1242000' -i init.mako.rc
sed '/# disable diag port/ i\    write /sys/devices/system/cpu/cpu1/online 1' -i init.mako.rc
sed '/# disable diag port/ i\    write /sys/devices/system/cpu/cpu2/online 1' -i init.mako.rc
sed '/# disable diag port/ i\    write /sys/devices/system/cpu/cpu3/online 1' -i init.mako.rc
...
sed '/restorecon_recursive \/sys\/devices\/system\/cpu\/cpufreq\/interactive/ a\    write /sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay "20000 918000:60000 1242000:150000"' -i init.mako.rc
sed '/interactive\/above_hispeed_delay "20000 918000:60000 1242000:150000"/ a\    write /sys/devices/system/cpu/cpufreq/interactive/go_hispeed_load 99' -i init.mako.rc
...
sed '/interactive\/io_is_busy 1/ a\    write /sys/devices/system/cpu/cpufreq/interactive/target_loads "90 384000:40 918000:80 1242000:95"' -i init.mako.rc
sed '/interactive\/target_loads "90 384000:40 918000:80 1242000:95"/ a\    write /sys/devices/system/cpu/cpufreq/interactive/min_sample_time 60000' -i init.mako.rc
...
sed '/cpu_boost\/parameters\/boost_ms 20/ a\    write /sys/module/cpu_boost/parameters/input_boost_freq 918000' -i init.mako.rc
sed '/cpu_boost\/parameters\/input_boost_freq 918000/ a\    write /sys/module/cpu_boost/parameters/input_boost_ms 100' -i init.mako.rc
